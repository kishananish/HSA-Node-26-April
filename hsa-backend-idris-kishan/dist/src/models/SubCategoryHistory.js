...
var SubCategoryHistorySchema = new Schema({
    _id: { type: String, 'default': _shortid2.default.generate },
    operation: {
        type: String,
...
var SubCategoryHistory = _mongoose2.default.model('SubCategoryHistory', SubCategoryHistorySchema);

exports.default = SubCategoryHistory;