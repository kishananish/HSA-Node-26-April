...
var contactUsHistorySchema = new Schema({
    _id: { type: String, default: _shortid2.default.generate },
    operation: {
        type: String,
...
var ContactUsHistory = _mongoose2.default.model('ContactUsHistory', contactUsHistorySchema);

exports.default = ContactUsHistory;