...
var userValidator = {
	...
	appleLogin: {
		body: {
			...
			device_id: _joi2.default.string(),
			device_type: _joi2.default.string(),
			identityToken: _joi2.default.string()
		}
	},
	sendOtp: {
		body: {
	...
	mobileSignup: {
		body: {
			txnId: _joi2.default.string().required(),
			country: _joi2.default.string().allow(''),
			city: _joi2.default.string().allow(''),
			first_name: _joi2.default.string().min(3).max(30),
			last_name: _joi2.default.string().min(3).max(30),
			email: _joi2.default.string().email().required(),
			role: _joi2.default.string().equal('user', 'service_provider'),
			device_id: _joi2.default.string(),
			device_type: _joi2.default.string()
		}
	},
